  ...
  const workAreas = [
    {
      ...
      description: 'Providing quality education and vocational training to empower individuals with knowledge and skills for sustainable livelihoods.',
      projects: ['Digital Literacy Programs', 'Vocational Training Centers', 'Scholarship Programs', 'Adult Education Initiatives'],
      impact: '5,000+ students trained'
    },
    {
      icon: Heart,
      title: 'Healthcare & Wellness',
      description: 'Ensuring access to basic healthcare services and promoting wellness through preventive care and health education.',
      projects: ['Mobile Health Clinics', 'Maternal Health Programs', 'Nutrition Awareness', 'Mental Health Support'],
      impact: '3,000+ lives improved'
    },
    {
      icon: Leaf,
      title: 'Environmental Conservation',
      description: 'Promoting sustainable practices and environmental awareness to protect natural resources for future generations.',
      projects: ['Tree Plantation Drives', 'Waste Management', 'Water Conservation', 'Renewable Energy'],
      impact: '10,000+ trees planted'
    },
    {
      icon: Users,
      title: 'Community Development',
      description: 'Building stronger communities through infrastructure development, capacity building, and social cohesion programs.',
      projects: ['Infrastructure Development', 'Women Empowerment', 'Youth Programs', 'Senior Citizen Care'],
  ...
  const successStories = [
    {
      ...
      description: 'Established a digital learning center that has improved literacy rates by 40% in the local community.',
    ...
    },
    {
      ...
      description: 'Trained 200+ women in various skills, helping them start their own businesses and achieve financial independence.',
    ...
    },
    {
      ...
      description: 'Mobile health clinics providing regular checkups and preventive care to remote communities.',
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {successStories.map((story, index) => (
              <div key={index} className="card-elegant overflow-hidden animate-fade-in">
                ...
                />
                <div className="p-6">
                  <div className="text-sm text-primary font-medium mb-2">{story.location}</div>
